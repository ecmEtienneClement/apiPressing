...
const detailPiece_routes_1 = __importDefault(require("./detailPiece.routes/detailPiece.routes"));
const detailTypePiece_routes_1 = __importDefault(require("./detailTypeKilo.routes/detailTypePiece.routes"));
const detailTypePiece_routes_2 = __importDefault(require("./detailTypePiece.routes/detailTypePiece.routes"));
...
exports.default = (app) => {
    ...
    app.use("/detailPieces", auth_authorization_1.default, detailPiece_routes_1.default);
    app.use("/detailTypeKilo", auth_authorization_1.default, detailTypePiece_routes_1.default);
    app.use("/detailTypePieces", auth_authorization_1.default, detailTypePiece_routes_2.default);
    ...
    app.use("/infoKilo", auth_authorization_1.default, infoKilo_routes_1.default);
    app.use("/infoPiece", auth_authorization_1.default, infoPiece_routes_1.default);
    app.use("/linges", auth_authorization_1.default, linge_routes_1.default);
    app.use("/typeLinge", auth_authorization_1.default, typeLinge_routes_1.default);
    //NOT FOUND
    app.use("*/**", (req, res) => {
        res.status(404).json({ message: "Cette ressourc n'éxiste pas !" });
    });
};
